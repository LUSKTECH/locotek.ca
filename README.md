...
This project creates a minimal, but impactful, high-performance static site using Next.js, replacing the previous WordPress installation.
...
* **Deployment**: [Vercel](https://vercel.com/) (with support for [Netlify](https://www.netlify.com/))
